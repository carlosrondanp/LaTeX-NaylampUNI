...
\begin{minipage}{0.15\textwidth}{
    \includegraphics[width=3.5cm]{figuras/UNI.png}}
\end{minipage}
\hspace{25pt}
\begin{minipage}{0.75\textwidth}
\vspace{5mm}
    \Large{\textbf{\color{gris}Título del trabajo de investigación}} 
    \vspace{3mm}
...
\tableofcontents
\listoffigures
\listoftables\end{@twocolumnfalse}]
